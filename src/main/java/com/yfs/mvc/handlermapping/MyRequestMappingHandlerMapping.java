package com.yfs.mvc.handlermapping;
...
public class MyRequestMappingHandlerMapping extends MyRequestMappingInfoHandlerMapping  implements EmbeddedValueResolverAware {
    ...
    protected boolean isHandler(Class<?> beanType) {
        Boolean withController = AnnotationUtils.findAnnotation(beanType, Controller.class) != null;
        if (withController) {
            return withController;
        }
        Boolean withRequestMapping = AnnotationUtils.findAnnotation(beanType, RequestMapping.class) != null;
        return withRequestMapping;
    }
    ...
    protected RequestMappingInfo getMappingForMethod(Method method, Class<?> handlerType) {
        ...
        //TODO for yfs 根据RequestMapping判断该方法是否是springMVC可以执行的方法
        ...
        if (methodAnnotation != null) {
            ...
            if (typeAnnotation != null) {
                ...
                RequestMappingInfo methodInfo = createRequestMappingInfo(typeAnnotation, typeCondition);
                info = methodInfo.combine(info);
            }
        }
        return info;
    }
